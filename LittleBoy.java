...
public class LittleBoy extends AdvancedRobot {
    ...
    // --- [CORREÇÃO EVASÃO - PASSO 1] ---
    // A memória de longo prazo (mapa de perigo) agora usa 'Double' (com D maiúsculo)
    ...
    public void run() {
        ...
        while (true) {
            ...
            // Settings Movimentação (Defeito 4: Ainda previsível)
            if (counter < 16)
                setAhead(100);
            else
                setBack(100);
    ...
    // --- [CORREÇÃO EVASÃO - PASSO 4 - NOVO MÉTODO] ---
    /**
